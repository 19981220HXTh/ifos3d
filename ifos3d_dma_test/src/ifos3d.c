...
int main(int argc, char **argv){
	...
	double time_start1 = 0.0,time_start2 = 0.0,time_start3 = 0.0;
	double time_end1 = 0.0,time_end2 = 0.0,time_end3 = 0.0;
	double time_sum_s_and_v = 0.0;
	...
	float *** fbufferlef_to_rig, *** fbufferrig_to_lef;
	float *** fbuffertop_to_bot, *** fbufferbot_to_top;
	float *** fbufferfro_to_bac, *** fbufferbac_to_fro;
	...
	// double timeuse = (end.tv_sec - start.tv_sec) + (end.tv_usec-start.tv_usec)/1000000;
	// printf("time =%f s\n", timeuse);
	//test time
	struct timeval start1,end1,start2,end2,start3,end3,start4,end4;
	double sum_time_gradient_F = 0.0;
	double sum_time_update_s_elastic = 0.0;
	double sum_time_update_v_ssg = 0.0;
	...
	if(POS[2]==0){
		vx  =  f3tensor(0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		vy  =  f3tensor(0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		vz  =  f3tensor(0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		...
		if(METHOD){
			Ffvx  =  f4tensor(1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Ffvy  =  f4tensor(1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Ffvz  =  f4tensor(1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Fbvx  =  f4tensor(1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Fbvy  =  f4tensor(1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Fbvz  =  f4tensor(1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Ffivx  =  f4tensor(1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Ffivy  =  f4tensor(1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Ffivz  =  f4tensor(1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Fbivx  =  f4tensor(1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Fbivy  =  f4tensor(1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
			Fbivz  =  f4tensor(1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		} 

		sxy =  f3tensor(0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		syz =  f3tensor(0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	}
	...
	sxz =  f3tensor(0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	sxx =  f3tensor(0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	syy =  f3tensor(0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	szz =  f3tensor(0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
...
#ifdef Mask
    float *** bufferlef_to_rig_v1, *** bufferrig_to_lef_v1,*** bufferfro_to_bac_v1,*** bufferbac_to_fro_v1;
	float *** bufferlef_to_rig_v2, *** bufferrig_to_lef_v2,*** bufferfro_to_bac_v2,*** bufferbac_to_fro_v2;
	bufferlef_to_rig_v1 = f3tensor(1,NY/2,1,NZ,1,nf1);
	bufferrig_to_lef_v1 = f3tensor(1,NY/2,1,NZ,1,nf2);
	bufferfro_to_bac_v1 = f3tensor(1,NY/2,1,NX,1,nf1);
	bufferbac_to_fro_v1 = f3tensor(1,NY/2,1,NX,1,nf2);
	bufferlef_to_rig_v2 = f3tensor(NY/2+1,NY,1,NZ,1,nf1);
	bufferrig_to_lef_v2 = f3tensor(NY/2+1,NY,1,NZ,1,nf2);
	bufferfro_to_bac_v2 = f3tensor(NY/2+1,NY,1,NX,1,nf1);
	bufferbac_to_fro_v2 = f3tensor(NY/2+1,NY,1,NX,1,nf2);
	MPI_Request *req_send_5, *req_rec_5,*sreq_send_5, *sreq_rec_5;
	req_send_5=(MPI_Request *)malloc(5*sizeof(MPI_Request));
	req_rec_5=(MPI_Request *)malloc(5*sizeof(MPI_Request));
	sreq_send_5=(MPI_Request *)malloc(5*sizeof(MPI_Request));
	sreq_rec_5=(MPI_Request *)malloc(5*sizeof(MPI_Request));
#endif

	fbufferlef_to_rig = f3tensor(1,NY,1,NZ,1,2*nf1);
	fbufferrig_to_lef = f3tensor(1,NY,1,NZ,1,2*nf2);
	fbuffertop_to_bot = f3tensor(1,NX,1,NZ,1,2*nf1);
	fbufferbot_to_top = f3tensor(1,NX,1,NZ,1,2*nf2);
	fbufferfro_to_bac = f3tensor(1,NY,1,NX,1,2*nf1);
	fbufferbac_to_fro = f3tensor(1,NY,1,NX,1,2*nf2);
	...
	for (iteration=ITMIN;iteration<=ITMAX;iteration++){
		...
		if(METHOD){
			  ...
			  zero_invers(NX,NY,NZ,F_fv,F_bv,NFMAX,ntr_hess);}
		...
		for (ishot=1;ishot<=nshots;ishot++){
			...
			zero_wavefield(NX,NY,NZ,Fv,Fs,rxx,ryy,rzz,rxy,ryz,rxz,psi_sxx_x,psi_sxy_x,psi_sxz_x,psi_sxy_y,psi_syy_y,psi_syz_y,psi_sxz_z,psi_syz_z,psi_szz_z,psi_vxx,psi_vyx,psi_vzx,psi_vxy,psi_vyy,psi_vzy,psi_vxz,psi_vyz,psi_vzz);
			if(METHOD) zero_invers(NX,NY,NZ,F_fv,F_bv,NFMAX,0);
			...
			for (nt=1;nt<=NT;nt++){
				...
				int idx = NY/2 * slice + NX/2 * strip + NZ/2;
				if (isnan(Fv[idx * 3 + 1])) {
					printf("---###------------------------------------------------------> %s,  %d, nt: %d, MYID: %d \n", __FUNCTION__, __LINE__, nt, MYID);
...
#ifdef Mask
				time_start1=MPI_Wtime();
				update_v(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],nt,Fv,Fs,rho,rjp, rkp,rip,srcpos_loc,signals,signals,signals,nsrc_loc,absorb_coeff,0, 
				buffertop_to_bot, req_send_5, req_rec_5);
				// exchange_v2_1(Fv, buffertop_to_bot, req_send_5, req_rec_5);
				exchange_v2_2(Fv, bufferbot_to_top, req_send_5, req_rec_5);
				update_s_elastic_psourse(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],Fv,Fs,pi,u,uipjp,ujpkp,uipkp,
				sbuffertop_to_bot,sreq_send_5, sreq_rec_5,nt,srcpos_loc,signals,nsrc_loc);
				//psource(nt,Fs, srcpos_loc,signals,nsrc_loc);
				// exchange_s2_1(Fs,sbuffertop_to_bot,sreq_send_5, sreq_rec_5);
				exchange_s2_2(Fs,sbufferbot_to_top,sreq_send_5, sreq_rec_5);
				time_end1=MPI_Wtime();
				time_sum_s_and_v += time_end1 - time_start1;
#else

                /* update of particle velocities */
                gettimeofday(&start3, NULL);
				time_v_update[nt]+=update_v(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],nt,Fv,Fs,rho,rjp, rkp,rip,srcpos_loc,signals,signals,signals,nsrc_loc,absorb_coeff,0);
				gettimeofday(&end3, NULL);
				sum_time_update_v_ssg += (end3.tv_sec - start3.tv_sec)*1000000 + (end3.tv_usec-start3.tv_usec);
				




				if(ABS_TYPE==1){//ABS_TYPE在fw和inv中都为2 这部分先不管
					update_v_CPML(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],nt,vx,vy,vz,sxx,syy,szz,sxy,syz,sxz,rho,rjp,rkp,rip,srcpos_loc,signals,signals,signals,nsrc_loc,absorb_coeff,0,K_x,a_x,b_x,K_x_half,a_x_half,b_x_half,
							      K_y,a_y,b_y,K_y_half,a_y_half,b_y_half,K_z,a_z,b_z,K_z_half,a_z_half,b_z_half,psi_sxx_x,psi_sxy_x,psi_sxz_x,psi_sxy_y,psi_syy_y,psi_syz_y,psi_sxz_z,psi_syz_z,psi_szz_z);
				}

				/* exchange values of particle velocities at grid boundaries between PEs */
				time_v_exchange[nt]+=exchange_v(Fv, bufferlef_to_rig, bufferrig_to_lef, buffertop_to_bot, bufferbot_to_top,
				...
				time_s_update[nt]+=update_s_elastic(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],Fv,Fs,pi,u,uipjp,ujpkp,uipkp);
				gettimeofday(&end2, NULL);
				sum_time_update_s_elastic += (end2.tv_sec - start2.tv_sec)*1000000 + (end2.tv_usec-start2.tv_usec);
				...
				time_s_exchange[nt]+=exchange_s(Fs,sbufferlef_to_rig,sbufferrig_to_lef,sbuffertop_to_bot,sbufferbot_to_top,sbufferfro_to_bac,sbufferbac_to_fro, sreq_send, sreq_rec);
#endif

				/* extracting monochromatic wavefields */
				if(nt%ntast==0&&METHOD){
					discfourier(1,NX,1,NY,1,NZ,nt,Fv,F_fv,finv,nf,ntast,pshot,0);
					l++;
				}

				/* stress free surface ? */
				if ((FREE_SURF) && (POS[2]==0))
					surface_elastic(1,u,pi,Fs,Fv);
				...
				if ((SEISMO) && (ntr>0) && (nt==lsamp)){
					seismo(nlsamp,ntr,recpos_loc,sectionvx,sectionvy,sectionvz,
						sectiondiv,sectioncurl,sectionp,Fv,Fs,pi,u);
					nlsamp++;
					lsamp+=NDT;
				}
				...
				if ((SNAP) && (nt==lsnap) && (nt<=TSNAP2/DT)){
				    MPI_Barrier(MPI_COMM_WORLD);
				    snap(FP,nt,++nsnap,SNAP_FORMAT,SNAP,Fv,Fs,u,pi,IDX,IDY,IDZ,1,1,1,NX,NY,NZ);
			...
			if(METHOD==1){
				...
				if(METHOD){
					...
					exchange_Ffv(F_fv, nf, fbufferlef_to_rig, fbufferrig_to_lef, fbuffertop_to_bot, fbufferbot_to_top,
																					fbufferfro_to_bac, fbufferbac_to_fro, req_send, req_rec,0);
				...
				for(pshot=0;pshot<=hloop;pshot++){
					...
					for (nt=1;nt<=NT;nt++) {
						...
						/* Check if simulation is still stable */
						int idx = NY/2 * slice + NX/2 * strip + NZ/2;
						if (isnan(Fv[idx * 3 + 1])) err(" Simulation is unstable !"); /* maybe just breaking the loop would be better */
#ifdef Mask
                        time_start2=MPI_Wtime(); 
						update_v(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],nt,Fv,Fs,rho,rjp,rkp,rip,srcpos_loc_back,sectionvxdiff,sectionvydiff,sectionvzdiff,ntr_loc,absorb_coeff,1,
						buffertop_to_bot,req_send_5, req_rec_5);
						// exchange_v2_1(Fv, buffertop_to_bot, req_send_5, req_rec_5);
						exchange_v2_2(Fv, bufferbot_to_top, req_send_5, req_rec_5);
						update_s_elastic(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],Fv,Fs,pi,u,uipjp,ujpkp,uipkp,
						sbuffertop_to_bot,sreq_send_5, sreq_rec_5);
                        // exchange_s2_1(Fs,sbuffertop_to_bot,sreq_send_5, sreq_rec_5);
						exchange_s2_2(Fs,sbufferbot_to_top,sreq_send_5, sreq_rec_5);
						time_end2=MPI_Wtime();
						time_sum_s_and_v += time_end2 - time_start2;

#else
						/* update of particle velocities */
						gettimeofday(&start3, NULL);
						time_v_update[nt]+=update_v(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],nt,Fv,Fs,rho,rjp,rkp,rip,srcpos_loc_back,sectionvxdiff,sectionvydiff,sectionvzdiff,ntr_loc,absorb_coeff,1);
						gettimeofday(&end3, NULL);
						sum_time_update_v_ssg += (end3.tv_sec - start3.tv_sec)*1000000 + (end3.tv_usec-start3.tv_usec);
						...
						/* exchange values of particle velocities at grid boundaries between PEs */
						time_v_exchange[nt]+=exchange_v(Fv, bufferlef_to_rig, bufferrig_to_lef, buffertop_to_bot, bufferbot_to_top, bufferfro_to_bac, bufferbac_to_fro, req_send, req_rec);
						/*time_s_update[nt]+=update_s(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],vx,vy,vz,sxx,syy,szz,sxy,syz,sxz,rxx,ryy,rzz,rxy,ryz,rxz,pi,u,uipjp,ujpkp,uipkp,taus,tausipjp,tausjpkp,tausipkp,taup,eta);
						 * if(ABS_TYPE==1){
						 * update_s_CPML(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],vx,vy,vz,sxx,syy,szz,sxy,syz,sxz,rxx,ryy,rzz,rxy,ryz,rxz,pi,u,uipjp,ujpkp,uipkp,taus,tausipjp,tausjpkp,tausipkp,taup,eta,K_x,a_x,b_x,K_x_half,a_x_half,b_x_half,K_y,a_y,b_y,K_y_half,a_y_half,b_y_half,K_z,a_z,b_z,K_z_half,a_z_half,b_z_half,psi_vxx,psi_vyx,psi_vzx,psi_vxy,psi_vyy,psi_vzy,psi_vxz,psi_vyz,psi_vzz);}*/
...
#endif
						if(nt%ntast==0&&(METHOD)) {
							discfourier(1,NX,1,NY,1,NZ,nt,Fv,F_bv,finv,nf,ntast,pshot1,1);
							l++;
						}
				...
				if(!pshot){
				    exchange_Ffv(F_bv,nf, fbufferlef_to_rig, fbufferrig_to_lef, fbuffertop_to_bot, fbufferbot_to_top,
											fbufferfro_to_bac, fbufferbac_to_fro, req_send, req_rec,0);
					...
					gradient_F(NX,NY,NZ,F_fv,F_bv,grad1,grad2,grad3,nt,rho,pi,u,finv,nf,ntr_hess,iteration);
					gettimeofday(&end1, NULL);
					// time_gradient_F[nt-1] = (end1.tv_sec - start1.tv_sec) + (end1.tv_usec-start1.tv_usec)/1000000;
					sum_time_gradient_F = (end1.tv_sec - start1.tv_sec)*1000000 + (end1.tv_usec-start1.tv_usec);
					if(MYID == 0){
				...
				if(iteration==1 && HESS && !READ_HESS){
					...
					exchange_Fv(Fbivx,Fbivy,Fbivz,nf, bufferlef_to_rig, bufferrig_to_lef, buffertop_to_bot, bufferbot_to_top,
												bufferfro_to_bac, bufferbac_to_fro, req_send, req_rec,ntr_hess);*/
					MPI_Barrier(MPI_COMM_WORLD);
					hess_F(NX,NY,NZ,F_fv, F_bv, hess1,hess2,hess3,nt,rho, pi, u, finv, nf,ntr_hess);
				}
				hloop=0; ntr_loc=ntr;
				if(iteration==1 && HESS && !READ_HESS){
				for(i=1;i<=4;i++){
		...
		if(METHOD){
				...
				for (steptest=1;steptest<=2;steptest++) {
					...
					for (ishot=1;ishot<=NSHOTS_STEP;ishot++){
						...
						for (nt=1;nt<=NT;nt++) {
							...
							time_s_update[nt]=0.0;
							int idx = NY/2 * slice + NX/2 * strip + NZ/2;
							if (isnan(Fv[idx * 3 + 1])) err(" Simulation is unstable !");
#ifdef Mask
                            
							time_start3=MPI_Wtime();
							update_v(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],nt,Fv,Fs,testrho,rjp, rkp,rip,srcpos_loc,signals,signals,signals,nsrc_loc,absorb_coeff,0,
							buffertop_to_bot, req_send_5, req_rec_5);
							// exchange_v2_1(Fv, buffertop_to_bot, req_send_5, req_rec_5);
							exchange_v2_2(Fv, bufferbot_to_top, req_send_5, req_rec_5);
                            update_s_elastic_psourse(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],Fv,Fs,testpi,testu,uipjp,ujpkp,uipkp,
							sbuffertop_to_bot,sreq_send_5, sreq_rec_5,nt,srcpos_loc,signals,nsrc_loc);							
                            // psource(nt,Fs,srcpos_loc,signals,nsrc_loc);
                            // exchange_s2_1(Fs,sbuffertop_to_bot,sreq_send_5, sreq_rec_5);
							exchange_s2_2(Fs,sbufferbot_to_top,sreq_send_5, sreq_rec_5);
							time_end3=MPI_Wtime();
							time_sum_s_and_v += time_end3 - time_start3;

#else
							gettimeofday(&start3, NULL);
							time_v_update[nt]+=update_v(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],nt,Fv,Fs,testrho,rjp, rkp,rip,srcpos_loc,signals,signals,signals,nsrc_loc,absorb_coeff,0);
							gettimeofday(&end3, NULL);
							sum_time_update_v_ssg += (end3.tv_sec - start3.tv_sec)*1000000 + (end3.tv_usec-start3.tv_usec);
                            ...
                            gettimeofday(&start2, NULL);
							time_s_update[nt]+=update_s_elastic(xb[0],xb[1],yb[0],yb[1],zb[0],zb[1],Fv,Fs,testpi,testu,uipjp,ujpkp,uipkp);
							gettimeofday(&end2, NULL);
							sum_time_update_s_elastic += (end2.tv_sec - start2.tv_sec)*1000000 + (end2.tv_usec-start2.tv_usec);
							...
							if ((FREE_SURF) && (POS[2]==0))
                            	...
                            	surface_elastic(1,u,pi,Fs,Fv);
                            if ((SEISMO) && (ntr>0) && (nt==lsamp)) {
                            	seismo(nlsamp,ntr,recpos_loc,sectionvx,sectionvy,sectionvz,sectiondiv,sectioncurl,sectionp,Fv,Fs,testpi,testu);
                            	nlsamp++;
                            	lsamp+=NDT;
                            }
						}
			...
			if(MYID==0){
				time4=MPI_Wtime();
				LOG_INFO(FP,"\n Iteration finished; iteration time :%4.2f   sum update and exchange s & v :%lf\n", time4-time2 ,time_sum_s_and_v);
			}
		}/*fwi loop*/
	}/*iteration loop*/


    // double sum_gradient_F,sum_update_s_elastic,sum_update_v_ssg;
	// int it;
    // if (MYID == 0){
	// 	for (it = 0; it < NT; it++){
	// 		printf("nt: %d,  update_s_elastic: %lf s, update_v_ssg: %lf s\n", it, time_update_s_elastic[it],time_update_v_ssg[it]);
	// 		// sum_gradient_F += time_gradient_F[it];
	// 		sum_update_s_elastic += time_update_s_elastic[it];
	// 		sum_update_v_ssg += time_update_v_ssg[it];
	// 	}
	// 	fprintf(FI,"sum, update_s_elastic: %lf s, update_v_ssg: %lf s\n", sum_update_s_elastic,sum_update_v_ssg);
    // 		// printf("time of exchange: %lf, time of update: %lf\n", time_s_exchange[nt], time_s_update[nt]);
	// }
	// if (MYID == 0){
	// 	// for (nt = 0; nt < NT; nt++)
    // 	// 	printf("time of exchange: %lf, time of update: %lf\n", time_s_exchange[nt], time_s_update[nt]);
	// 	printf("sum--  gradient_F: %lf s, update_s_elastic: %lf s, update_v_ssg: %lf s\n",sum_time_gradient_F/1000000, sum_time_update_s_elastic/1000000, sum_time_update_v_ssg/1000000);
	// }
	...
	if(POS[2]==0){
	free_f3tensor(vx,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	free_f3tensor(vy,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	free_f3tensor(vz,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
    free_f3tensor(sxy,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	free_f3tensor(syz,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	if(METHOD){
		free_f4tensor(Ffvx,1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Ffvy,1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Ffvz,1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Fbvx,1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Fbvy,1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Fbvz,1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Ffivx,1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Ffivy,1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Ffivz,1,NFMAX,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Fbivx,1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Fbivy,1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
		free_f4tensor(Fbivz,1,NFMAX*(ntr_hess+1),0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	}
	}
	...
	free_f3tensor(sxz,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	free_f3tensor(sxx,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	free_f3tensor(syy,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	free_f3tensor(szz,0-l*FDORDER/2,NY+l*FDORDER/2,1-l*FDORDER/2,NX+l*FDORDER/2,1-l*FDORDER/2,NZ+l*FDORDER/2);
	...
	free_f3tensor(fbufferlef_to_rig,1,NY,1,NZ,1,2*nf1);
	free_f3tensor(fbufferrig_to_lef,1,NY,1,NZ,1,2*nf2);
	free_f3tensor(fbuffertop_to_bot,1,NX,1,NZ,1,2*nf1);
	free_f3tensor(fbufferbot_to_top,1,NX,1,NZ,1,2*nf2);
	free_f3tensor(fbufferfro_to_bac,1,NY,1,NX,1,2*nf1);
	free_f3tensor(fbufferbac_to_fro,1,NY,1,NX,1,2*nf2);
