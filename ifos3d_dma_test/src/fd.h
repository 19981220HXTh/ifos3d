...
void inverse_3(float *p, float ***a, float ***b, float ***c, int nrl, int nrh, int ncl, int nch, int ndl, int ndh);
...
void seismo(int lsamp, int ntr, int **recpos, float **sectionvx, float **sectionvy, float **sectionvz, float **sectiondiv, float **sectioncurl, float **sectionp, float *Fv, float *Fs, float ***pi, float ***u);
...
float ***vx, float ***vy, float ***vz, float ***sxx, float ***syy, float *** sxy, float *** syz, float *** sxz, float ***szz, float ***u, float ***pi,
int idx, int idy, int idz, int nx1, int ny1, int nz1, int nx2, 
int ny2, int nz2);*/
...
double update_s_elastic_psourse(int nx1, int nx2, int ny1, int ny2, int nz1, int nz2, float *Fv, float *Fs, float ***  pi, float ***  u, float ***  uipjp, float ***  ujpkp, float ***  uipkp, float *** buffertop_to_bot, MPI_Request * req_send, MPI_Request * req_rec,int nt,float **  srcpos_loc, float ** signals, int nsrc_loc) ;
...
//void surface_elastic(int ndepth, float *** u, float *** pi,float *** sxx, float ***syy, float ***szz, float *** sxy,float *** syz, float *** sxz, float *** vx, float *** vy, float *** vz);
